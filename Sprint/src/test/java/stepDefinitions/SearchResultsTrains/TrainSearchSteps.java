...
//TrainSearchSteps.java
public class TrainSearchSteps {

 // NO constructor, NO injected ctx field
 private ScenarioContext ctx() {
     return ScenarioContext.get(); // always THIS thread's instance
 }
 ...
 public void user_enters_loaded_invalid() throws InterruptedException {
     ctx().searchPage.typeInvalidDestination(ctx().currentInvalidDest);
 }
